...
| [llm](./llm) | 基于 [goai](https://github.com/zendev-sh/goai) 的 LLM 封装：链式 Session、`Execute` / `ExecuteTo` / `Stream`。 | ✅ 稳定 |
...
| [gsc](./gsc) | Google Search Console API：搜索分析、URL 检查、站点与 Sitemap 管理。 | ✅ 稳定 |
